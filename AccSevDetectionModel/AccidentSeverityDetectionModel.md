# 🚨 AccidentSeverityDetectionModel — Road Accident Severity Detection
...
**YERRAGUNTLA KAMESWARA SAI SRIKAR** — [DockerHub: srikar77](https://hub.docker.com/u/srikar77)
**YERRAGUNTLA KAMESWARA SAI SRIKAR** — [GITHUB: Y-K-SAI-SRIKAR](https://github.com/Y-K-SAI-SRIKAR)
**YERRAGUNTLA KAMESWARA SAI SRIKAR** — [LINKEDIN: Yerraguntla Kameswara Sai Srikar](https://www.linkedin.com/in/y-k-sai-srikar/)
---
